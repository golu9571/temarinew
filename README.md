![Image](https://telegra.ph/file/bb7623cc9ff0f5ea74ee6.jpg)
...
This file should be placed in your `Ryuzuki` folder, alongside the `__main__.py` file. 
...
```
from Ryuzaki.sample_config import Config
